...
# fpgen.py --pins="6" --pinshigh="3" --padwidth="0.62mm" --padlength="1.22mm" --padspacing="0.95mm" --soldermask="3mil" --clearance="10mil" --pkgwidth="3.85mm" --name="LTC_S5" --description="5-pin TSOT-23 (Based on LTC S5 package)" --silkwidth="4.4mm" --silkheight="3.1mm" --silkthickness="10mil"
# 
# Name:        LTC_S5
# Description: 5-pin TSOT-23 (Based on LTC S5 package)
# 
# Dual Package
# Pins:        6
...
Element[0x00000000 "LTC_S5" "" "" 0 0 0 0 0 100 0x00000000]
(
	# West
	...
	Pad[6358 -3740 3996 -3740 2441 2000 3041 "5" "5" "square"]
	# Outline
